...
public class AuthenticationApplyController {
    ...
    public Object authenticationApplyList(AuthenticationApply apply) {
    	...
    	if (list != null && list.size() > 0) {
			for (AuthenticationApply authenticationApply : list) {
				authenticationApply.setIdCardBack(authenticationApply.getIdCardBack());
				authenticationApply.setIdCardFront(authenticationApply.getIdCardFront());
			}
		}
	...
	public ModelAndView showAuthenticationApply(AuthenticationApply apply) {
		...
		apply1.setIdCardFront(apply1.getIdCardFront());
		apply1.setIdCardBack(apply1.getIdCardBack());
		apply1.setImage(apply1.getImage());

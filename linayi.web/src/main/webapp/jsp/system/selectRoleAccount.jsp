...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/system/controllers/selectRoleAccountController.js"></script>
<script type="text/javascript" src="resource/js/system/services/selectRoleAccountService.js"></script>
</head>
<body>

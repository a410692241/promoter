            	...
            	<form class="form-inline">
							...
							<div class="form-group form-group-margin">
		                        <div class="input-group">
		                            ...
		                            <input datetimepicker ng-model="search.createTimeStart" ng-model="search.type" type="text" class="form-control">
		                        </div>
		                       	 至
		                        <div class="input-group">
		                    ...
		                    <div class="form-group form-group-margin" ng-show="search.communityId">
		                        <div class="input-group">
		                            <span class="input-group-addon">状态</span>
		                          <select ng-model="search.type" ng-change="getType(search.type)" ng-init="search.type='showAll'">
		                          	<option value="showAll">全部</option>
		                          	<option value="showBind">绑定</option>
		                          	<option value="showUnbind">未绑定</option>
		                          </select>
		                        </div>
		                    </div>

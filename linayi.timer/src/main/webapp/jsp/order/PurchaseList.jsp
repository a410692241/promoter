...
<head>
    <meta charset="utf-8" />
    <script type="text/javascript" src="resource/js/order/services/PurchaseService.js"></script>
    <script type="text/javascript" src="resource/js/order/controllers/PurchaseController.js"></script>
</head>
<body>
<div class="row" ng-controller="purchaseCtrl">
    <div class="col-xs-12 col-md-12">
        <div class="widget">
            ...
            <div class="widget-body">
                    ...
                    <div class="form-group form-group-margin">
                        <div class="input-group">
                            ...
                            <%--<ui-select--%>
                                ...
                                <%--</ui-select-choices>--%>
                            <%--</ui-select>--%>
                            <input ng-model="search.supermarketName" type="text" class="form-control">
                        </div>
                    </div>
                    <div class="form-group form-group-margin">
                        <div class="input-group">
                            ...
                            <%--<ui-select--%>
                                    <%--on-select="search.userStatus = $item.code"--%>
                ...
                <!-- 表格 -->
                <table id="purchaseList" style="width: 100%"></table>
                <!-- 分页 -->

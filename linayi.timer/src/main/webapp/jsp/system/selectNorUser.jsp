...
<head>
<meta charset="utf-8" />
<script type="text/javascript" src="resource/js/system/controllers/selectNorUserController.js"></script>
<script type="text/javascript" src="resource/js/system/services/selectNorUserService.js"></script>
</head>
<body>
